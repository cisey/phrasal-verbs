...
<div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
  <span style="font-size: 1.1rem; color: var(--primary-orange);"><b>Telaffuz:</b> <code>/leɪ aʊt/</code></span>
...
❌ **Yanlış:** Please layout the details (Yanlış: 'layout' isimdir, fiil olarak 'lay out' yazılmalıdır)

✅ **Doğru:** The manager laid out the new strategy in detail.
...
🔄 **Benzer:** set out, spell out, talk through

↔️ **Zıt:** conceal, obscure
...
Hem resmi hem günlük dilde kullanılır, ancak yazılı ve sözlü anlatımda yaygındır.
