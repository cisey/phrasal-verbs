---
title: Throw Up Ne Demek? Anlamı ve Örnek Cümleler
description: Throw up, İngilizcede kusmak anlamına gelen bir phrasal verb'dür. Bir
  kişi throw up yaptığında midesindeki içeriği ağzından dışarı çıkarır. Türkçede en...
tags:
- Günlük Konuşma
...
<div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
  <span style="font-size: 1.1rem; color: var(--primary-orange);"><b>Telaffuz:</b> <code>/θroʊ əp/</code></span>
