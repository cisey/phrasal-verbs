...
<div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
  <span style="font-size: 1.1rem; color: var(--primary-orange);"><b>Telaffuz:</b> <code>/pæk ɪn/</code></span>
...
❌ **Yanlış:** 'Pack in' fiilini 'paketlemek' olarak çevirmek (örneğin, 'I packed in my job' cümlesini 'İşimi paketledim' şeklinde anlamak).

✅ **Doğru:** I packed in my job last week because I was exhausted. (Geçen hafta işimi bıraktım çünkü çok yorgundum.)
...
🔄 **Benzer:** give up, quit, stop, abandon, call it quits
...
Bu ifade günlük konuşma dilinde ve gayri resmi bağlamlarda kullanılır; resmi yazılarda pek tercih edilmez.
