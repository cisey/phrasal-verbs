...
description: Dish out, birine özellikle para, ceza, eleştiri ya da bilgi gibi şeyleri
  düşünmeden, genellikle hızlı ve bol miktarda vermek anlamına gelir. Bu deyim, bir...
tags:
- Günlük Konuşma
- İş İngilizcesi
...
<div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
  <span style="font-size: 1.1rem; color: var(--primary-orange);"><b>Telaffuz:</b> <code>/dɪʃ aʊt/</code></span>
